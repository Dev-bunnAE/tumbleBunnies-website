...
import { FolderOpen, LogOut, Rabbit, User } from "lucide-react";
...
export function AdminHeader() {
  ...
  return (
    <header className="bg-gradient-to-r from-bubblegum via-sky to-salmon text-primary-foreground sticky top-0 z-50 shadow border-b">
      <nav className="container mx-auto px-4 flex items-center justify-between h-16">
        <div className="flex items-center gap-8">
          <Link href="/admin" className="font-headline text-2xl font-bold tracking-tight hover:opacity-90 transition-opacity relative flex items-center gap-2">
