...
"[project]/src/context/cart-context.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const CartProvider = ({ children })=>{
    ...
    const addItem = (itemToAdd)=>{
        setItems((prevItems)=>{
            ...
            if (existingItem) {
                ...
                return prevItems.map((item)=>item.id === itemToAdd.id ? {
                        ...item,
    ...
    const updateItemChild = (itemId, childName)=>{
...
"[project]/src/lib/firebase.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const firebaseConfig = {
    ...
    storageBucket: "tumblebunnies-website.appspot.com",
...
const uploadImage = async (file, path)=>{
    const storageRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ref"])(storage, path);
...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(auth, (user)=>{
            setUser(user);
            setLoading(false);
        });
        return ()=>unsubscribe();
    ...
    const signInWithGoogle = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__d__as__signInWithPopup$3e$__["signInWithPopup"])(auth, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__Y__as__GoogleAuthProvider$3e$__["GoogleAuthProvider"]());
            return {};
        } catch (error) {
            return {
                error: error.message
    ...
    const getRegistrationAsync = async (userId)=>{
        try {
            const registrationsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(db, "registrations");
    ...
    const getPendingRegistration = (userId)=>{
        try {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        fileName: "[project]/src/lib/firebase.tsx",
        lineNumber: 245,
        columnNumber: 10
    }, this);
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0705898b._.js.map